...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Nov-2017 às 18:28
...
(17, 'Partido do Trabalhador', '5a0dca0e19f20.jpg', 60, 'Presidenta', 'Belo Horizonte', 'Minas Gerais', '57/65/767', 4);
...
(4, 'Partido do Trabalhador', '5a0dbb420a287.jpg', 'PT', '16/11/2017', 'Karl Marx');
...
ALTER TABLE `tb_candidatos`
 ADD PRIMARY KEY (`id_candidato`), ADD KEY `fk_partido` (`id_partido`);
...
--
ALTER TABLE `tb_candidatos`
MODIFY `id_candidato` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `tb_eventos`
--
ALTER TABLE `tb_eventos`
MODIFY `id_evento` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tb_noticias`
MODIFY `id_noticia` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
